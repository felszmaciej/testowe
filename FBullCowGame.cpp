...
{
	const FString HIDDEN_WORD = "cegla";  //This must be an isogram!!!!!
...
{
	if (!IsIsogram(Guess)) // if the guess isn t a isogram then return the error
	{
...
bool FBullCowGame::IsIsogram(FString Word) const
{
	...
	return true; // for exapmple is cases where /o is entered
}
